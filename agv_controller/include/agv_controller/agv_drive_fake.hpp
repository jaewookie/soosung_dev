...
#ifndef AGV_FAKE_NODE__AGV_FAKE_NODE_HPP_
#define AGV_FAKE_NODE__AGV_FAKE_NODE_HPP_
...
class AgvFake : public rclcpp::Node
{
public:
  AgvFake();
  ~AgvFake();
...
#endif  // AGV_FAKE_NODE__AGV_FAKE_NODE_HPP_
