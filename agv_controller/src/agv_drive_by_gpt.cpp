...
#include "agv_controller/agv_drive_by_gpt.hpp"
...
AgvDriveGPT::AgvDriveGPT(const rclcpp::NodeOptions &node_options)
      ...
      wheel_radius_(DRIVE_WHEEL_RADIUS)
{
  ...
  cmdvel_subscriber_ = this->create_subscription<geometry_msgs::msg::Twist>(
      "/cmd_vel", QOS_RKL10V, std::bind(&AgvDriveGPT::cmd_vel_callback, this, std::placeholders::_1));

  joint_state_publisher_ = this->create_publisher<sensor_msgs::msg::JointState>("/joint_states", 10);
  odom_publisher_ = this->create_publisher<nav_msgs::msg::Odometry>("/odom", 10);
  tf_broadcaster_ = std::make_shared<tf2_ros::TransformBroadcaster>(this);

  timer_ = this->create_wall_timer(10ms, std::bind(&AgvDriveGPT::publish_states, this));
}

AgvDriveGPT::~AgvDriveGPT() {}

void AgvDriveGPT::cmd_vel_callback(const geometry_msgs::msg::Twist::SharedPtr msg)
{
...
int main(int argc, char *argv[])
{
  ...
  rclcpp::spin(std::make_shared<AgvDriveGPT>());
  rclcpp::shutdown();
  return 0;
}
