...
private:
  ...
  void process_chunk(const std::vector<unsigned char> &chunk)
  {
    if (chunk.size() >= 67)
    {
      ...
      uint32_t timestamp;
      std::memcpy(&timestamp, &chunk[6], sizeof(timestamp));
      ...
      float accel_x;
      std::memcpy(&accel_x, &chunk[10], sizeof(accel_x));
      uint32_t accel_x_int;
      std::memcpy(&accel_x_int, &accel_x, sizeof(accel_x_int));
      accel_x_int = ntohl(accel_x_int); // Convert from network byte order to host byte order
      ...
      float accel_y;
      std::memcpy(&accel_y, &chunk[14], sizeof(accel_y));
      ...
      float accel_z;
      std::memcpy(&accel_z, &chunk[18], sizeof(accel_z));
      ...
      float gyro_x;
      std::memcpy(&gyro_x, &chunk[22], sizeof(gyro_x));
      uint32_t gyro_x_int;
      ...
      float gyro_y;
      std::memcpy(&gyro_y, &chunk[26], sizeof(gyro_y));
      uint32_t gyro_y_int;
      ...
      float gyro_z;
      std::memcpy(&gyro_z, &chunk[30], sizeof(gyro_z));
      uint32_t gyro_z_int;
      ...
      float quat_w;
      std::memcpy(&quat_w, &chunk[46], sizeof(quat_w));
      uint32_t quat_w_int;
      ...
      float quat_x;
      std::memcpy(&quat_x, &chunk[50], sizeof(quat_x));
      uint32_t quat_x_int;
      ...
      float quat_y;
      std::memcpy(&quat_y, &chunk[54], sizeof(quat_y));
      uint32_t quat_y_int;
      ...
      float quat_z;
      std::memcpy(&quat_z, &chunk[58], sizeof(quat_z));
      uint32_t quat_z_int;
